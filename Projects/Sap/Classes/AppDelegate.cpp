...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    //CocosDenshion::SimpleAudioEngine::sharedEngine()->preloadEffect("sound/vote.wav");
...
void AppDelegate::didReceiveRemoteNotification()
{
    RootWindow::getInstance()->didReceiveRemoteNotification();
}
